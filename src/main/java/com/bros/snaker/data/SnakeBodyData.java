...
public class SnakeBodyData {
    public static String B_T_R = "-fx-background-radius: " + Statics.SNAKE_CELL_HEIGHT + " 0 0 0 ;";
    public static String B_T_L = "-fx-background-radius: 0 " + Statics.SNAKE_CELL_HEIGHT + " 0 0;";
    public static String L_T_T = "-fx-background-radius: 0 0 " + Statics.SNAKE_CELL_HEIGHT + " 0;";
    public static String R_T_T = "-fx-background-radius: 0 0 0 " + Statics.SNAKE_CELL_HEIGHT + ";";
